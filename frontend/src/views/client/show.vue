<template>
  <div class="flex flex-col">
    <div>
      <breadcrumb
        class="mb-2"
        :title="t('labels.facilities')"
        :linkText="t('labels.company')"
        linkHref="/instalacoes/empresas"
        :showAdd = true
        @add="openModalcreate"
      />
    </div>
...
import clientService from "../../shared/api/services/client.service.js";
...
async function getById() {
  try {
    ...
    const response = await clientService.getById(id_current);
